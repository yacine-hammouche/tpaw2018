...
|| document.getElementById("Prenom").value.length<5 || document.getElementById("Date").value.length<10
|| document.getElementById("Adresse").value.length<5 || document.getElementById("Mail").value.length<5)
